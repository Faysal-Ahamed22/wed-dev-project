...
INSERT INTO `questions2` (`id`, `topic`, `question`, `option_a`, `option_b`, `option_c`, `option_d`, `answer`) VALUES
(1, 'c++', 'What is the output of: cout << 2 + 2;', '2', '4', '22', 'Error', '4'),
(2, 'c++', 'Which symbol is used for single line comments in C++?', '//', '#', '/*', '--', '//'),
(3, 'java', 'Which keyword is used for inheritance in Java?', 'extends', 'implements', 'inherits', 'None', 'extends'),
(4, 'python', 'What is the output of print(2 ** 3)?', '6', '8', '9', 'None', '8'),
(5, 'c++', 'How do you declare a pointer in C++?', 'int ptr;', 'int *ptr;', 'pointer int ptr;', 'int& ptr;', 'int *ptr;');
...
('Faysal', 'M', 'university of barishal', 'faysal.cse8.bu@gmail.com', 1909695098, '827ccb0eea8a706c4c34a16891f84e7b'),
