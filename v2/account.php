...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="user_login.php"><b>Special Quiz</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Dp.png.png" width=100 height=100 alt="Faysal " class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/sunnygkp10" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Md Faysal Ahamed </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01909695098</h4>
		<h4 style="font-family:'typo' ">faysal@gmail.com</h4>
		<h4 style="font-family:'typo' ">University Of Barishal</h4></div></div>
		</p>
      </div>
